...
<div class="page-content">
  <div class="row">
    <div class="col-xs-12">
      <div class="row">
        <div class="col-sm-3 col-md-3" style="padding-right: 4px !important;">
          <div class="widget-box">
            ...
            <div class="widget-body">
              <div class="widget-main my-content-height">
        ...
        <div class="col-sm-2 col-md-2" style="padding-left: 4px !important; ">
          <div class="widget-box ">
            <div class="widget-header">
              <h4 class="smaller">
                考试信息
...
<script id="template-moni-question-card-id" type="text/html">
  <a id="moni-card-{questionId}" data-question-id="{questionId}"
     class="btn btn-app no-radius my-btn-tihao my-btn-moni-tihao {answer}">
    {customIndex}
...
<script id="template-moni-option-checked-id" type="text/html">
  <label class="radio my-radio" data-key="{key}" data-label="{label}">
    <input type="{type}" class="ace" checked="checked" name="moni-option-{questionId}">
        <span class="lbl">
            <span>
                {label}、
            </span>
...
<script src="${basePath}assets/system/pufa/js/exam.js"></script>
<script type="text/javascript">
  ...
  $(window).bind('beforeunload', function (evt) {
    evt.stopPropagation();
    evt.preventDefault();
    return '您将要退出本次考试，退出后可能会出现您答题数据丢失的情况';
  });
</script>

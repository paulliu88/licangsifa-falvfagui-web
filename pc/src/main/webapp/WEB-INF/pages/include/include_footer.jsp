...
//        return;
    ...
    if ('test_pre' == flag) { // 如果是测试页面之前的页面
      $('#my-test-menu').addClass('my-menu-item-active');
    }
    if ('ti_panduan' == flag || 'ti_danxuan' == flag || 'ti_duoxuan' == flag || 'ti_all' == flag || 'main' == flag) {
...
//                    alert("服务器系统内部错误，点击确定后重新加载本页面");
          bootbox.confirm({
            ...
            message: '服务器已停止，稍后重试或联系管理员（电话：15854207636）',
            callback: function (result) {
              if (result) {

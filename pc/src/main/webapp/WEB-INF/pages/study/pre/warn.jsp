        ...
        <div class="row">
            ...
            <div class="col-xs-10">
                <div style="font-size: 18px;text-indent: 2em;line-height: 32px;margin-top:70px;text-align: left">
                    <h1  style="text-align:center;margin-bottom:40px;font-weight: bold"><img src="assets/system/pufa/img/xingxing.png" style="margin-right:30px;width:60px;" /><span  style="padding-bottom:7px; border-bottom:3px double #000;">注&nbsp;&nbsp;意&nbsp;&nbsp;事&nbsp;&nbsp;项</span></h1>
                  <p>
                    本期<span style="color:red;">《李沧区提高干部依法行政能力网络研修班》</span>的网上学习时间为<span style="color:red;">20小时</span>。通过网页版与手机版学习同步累计学习时间。每做一题系统会自动计时30秒，<span style="color:red;">做题时间低于5秒不计时</span>，请务必于9月30日前完成20小时的学习任务。</p>
                    <p>

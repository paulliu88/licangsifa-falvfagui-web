...
<div class="page-content">
            ...
            <div class="row">
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-body" >
                            <div class="widget-main my-content-height my-content-bgcolor" style="min-height: 510px !important;background: none;">
                                ...
                                <%--style="width: 35%;"></div>--%>
                                <%--</div>--%>
                                <div class="tabbable" margin-top: 3px;>
                                    ...
                                    <div class="tab-content" id="my-xuexi-tab-content" style="padding: 0px 0px;">
                                        <div id="study-panduan-tab" class="tab-pane">
                                            ...
                                            <div class="my-btn-xuexi-top">
                                                ...
                                                <div style="margin:20px 10px !important;font-size: 12px !important">
                                                    第<span></span>页，共<span></span>页</div>
                                        ...
                                        <div id="study-danxuan-tab" class="tab-pane in active">
                                            <div id="xuexi-danxuanti-id">
                                                <%--************************* CONTENT ******************************--%>
                                            </div>
                                            <hr>
                                            <div class="my-btn-xuexi-top" style="margin-left: 0px;">
                                                <button class="btn btn-xs btn-info  my-btn-xuexi-fenye-pre">
                                                    <%--<i class="icon-arrow-left icon-on-left"></i>--%>
                                                    上50题
                                                </button>
                                                <span style="font-size: 10px !important">
                                                    第<input type="text" style="width: 24px;margin: 0 4px;" onkeyup="DANXUANTI_QUESTION.changePage(this);"/>
                                                    页，共<span></span>页
                                                </span>
                                                <button class="btn btn-xs btn-info  my-btn-xuexi-fenye-next">
                                                    下50题
                                        ...
                                        <div id="study-duoxuan-tab" class="tab-pane">
                                            ...
                                            <div style="text-align: center;">
                                                ...
                                                <span style="margin:0 10px !important;font-size: 15px !important">
                ...
                <div class="col-sm-7 col-md-7" style="padding-left: 0px;padding-right: 0px;">
                    <div class="widget-box">
                        ...
                        <div id="xuexi-question-detail-id" class="widget-body" style="padding-bottom: 30px !important;background:#d0f6e3;">
                            <%--***************************** CONTENT ******************************--%>
                        </div>
                    </div>
                ...
                <div class="col-sm-2 col-md-2">
                    <div class="widget-box">
                        ...
                        <div class="widget-body my-content-bgcolor" style="padding-bottom: 30px !important;background: none;">
    ...
    <script id="template-xuexi-question-detail-up-id" type="text/html">
        ...
        <span class="my-span-question-title">
            ...
            <span class="my-title-shuoming">单选题：请选择一个正确答案</span>
        </span>
    ...
    <script id="template-xuexi-question-detail-down-id" type="text/html">
        ...
        <div class="row" style=" bottom: 30px;float: right;position: absolute;right: 41px;">
            <div class="col-xs-1 my-col-xs">
                <button class="btn my-btn-qiehuanti  btn-info my-btn-shoucang-benti" data-collection-type="{collectionType}"
...
<script src="${basePath}assets/system/pufa/js/danxuanti.js"></script>

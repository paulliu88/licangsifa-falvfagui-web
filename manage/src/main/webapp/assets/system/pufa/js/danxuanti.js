...
(function () {
    ...
    function initQuestionCardXuexi() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var ___questionId = window.localStorage.getItem('__currentUserQuestionIdDanxuanti');
                if (!___questionId) {
    ...
    function eventLiulanXuexi() {
        $('#xuexi-liulan-id').change(function () {
            ...
            var __currentUserQuestionIdDanxuanti = window.localStorage.getItem('__currentUserQuestionIdDanxuanti');
            var btns = $('#xuexi-' + __currentUserQuestionIdDanxuanti).children().eq(3).children('div').children('button');
            if (_checked) {
            ...
            disableOptions(__currentUserQuestionIdDanxuanti);
        });
    }
    ...
    function traceQuestion(questionId) {
        window.localStorage.setItem('__currentUserQuestionIdDanxuanti', questionId);

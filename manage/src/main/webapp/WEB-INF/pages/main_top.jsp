  ...
  <div class="navbar-container" id="navbar-container">
    <div class="navbar-header pull-left">
      <a href="#" class="navbar-brand">
        <small>
          <%--<i class="icon-leaf"></i>--%>
          <img src="${basePath}assets/system/pufa/img/biaozi.png" style="width: 20px;">
          李沧区干部法律法规学习测试系统管理系统
        </small>
      </a><!-- /.brand -->
    </div>
    ...
    <div class="navbar-header pull-right" role="navigation" style="display: none;">
      <ul class="nav ace-nav">
        ...
        <li class="green">
          ...
          <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
            ...
            <li>
              <a href="#">
                <img src="${basePath}assets/avatars/avatar3.png" class="msg-photo"
                     alt="Susan's Avatar"/>
										<span class="msg-body">
											<span class="msg-title">

...
<head>
  ...
  <meta charset="utf-8"/>
  <title>李沧区干部法律法规学习测试系统管理系统</title>
  <link rel="shortcut icon" href="${basePath}assets/system/pufa/img/logo.ico"/>
  <meta name="keywords" content=""/>
  <meta name="description" content="恒志诚出品,ybkk1027@gmail.com"/>
  ...
  <link rel="stylesheet" href="${basePath}assets/js/datatables/css/jquery.dataTables.min.css"/>
  <link rel="stylesheet" href="${basePath}assets/css/hzc.datatable.css"/>
  ...
  <script src="${basePath}assets/wdatepicker/WdatePicker.js"></script>

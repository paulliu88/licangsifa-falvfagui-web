                            ...
                            <form class="form-horizontal" action="UserCtrl.enrollExam.do" method="post"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <span name="userName" id="userName" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <span name="birthday" id="birthday" type="text"
                                                  style="border:1px solid #1687d5;"
                                                  class="col-xs-10 col-sm-10"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label no-padding-right">
                                            <span style="font-size: 16px;">手机号码</span><span
                                                style='color:red;margin-left: 5px;'>*</span>：</label>
...
<script type="text/javascript">
    ...
    function errorPrompt(obj, mess) {
        ...
        obj.parent().after('<span style="float: left;padding-left: 12px;color: #d68273;">' + mess + '</span>');
        setTimeout(function () {
    ...
    function nextStep() {
        ...
        $("#phone2").html(phone);
        if (phone == '') {
            yes = errorPrompt($phone, '请填写手机号');
        } else {
            var regPhone = /(^\d{11}$)/;
            if (regPhone.test(phone) === false) {
                yes = errorPrompt($phone, '请填写正确的手机号');
            }
        }

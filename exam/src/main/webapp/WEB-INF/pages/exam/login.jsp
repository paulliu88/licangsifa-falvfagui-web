                                    ...
                                    <div class="row" style="height: 210px !important;">
                                        <div class="col-xs-12">
                                            <h4 class="header blue lighter bigger" style="font-weight: 800;">
                                                <img src="${basepath}assets/system/pufa/img/exam-login-tubiao.png" style="width:26px;height:auto;margin-top: -5px;">
                                                考试登录
                                            </h4>

                                            <div class="space-6"></div>
                                            <form role="form" class="form-horizontal" action="UserCtrl.lcpfForExam.do"
                                                  method="post" onsubmit="return validate(this);" style="padding: 0px 40px 10px 0px !important;">
                                                ...
                                                <div class="clearfix" style="margin-top: 20px !important;text-align: center;">
                                                    <button id="submit-exam-btn-id" type="submit" class="my-button-join" style="font-size:16px;height:35px;">
                                                        登&nbsp;&nbsp;录
                                                    </button>
                                                </div>
                                                <div class="space-4"></div>
